...
{
   Pst pst;
   p5_p7_cfg *vnf_config = NULLP;

   DU_ALLOC_SHRABL_BUF(vnf_config, sizeof(p5_p7_cfg));
   if (vnf_config == NULLP)
   {
      return RFAILED;
   }

   extern p5_p7_cfg *nfapi_p5_p7_cfg; // defined in du_cfg.c
   memcpy(vnf_config, nfapi_p5_p7_cfg, sizeof(p5_p7_cfg));
